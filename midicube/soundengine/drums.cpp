...
void SampleDrums::process_voice_sample(double& lsample, double& rsample, SampleInfo& info, SimpleVoice& voice, SampleDrumsData& channel, KeyboardEnvironment& env, size_t note_index) {
	try {
